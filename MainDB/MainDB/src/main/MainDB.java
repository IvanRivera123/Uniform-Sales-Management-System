...
import main.DamageManager; // ✅ Add this import
        ...
        while (inside) {
            ...
            switch (userRole) {
                ...
                case "PRODUCTMANAGER" -> {
                    ...
                    System.out.println("2. Manage Damages");
                    System.out.println("3. Logout");
                    System.out.print("Enter choice: ");
                    int choice = readInt();
                    switch (choice) {
                        case 1 -> ProductManager.manageProducts(conn, sc);
                        case 2 -> DamageManager.damageMenu(conn, sc);
                        case 3 -> inside = false;
                        default -> {
                            System.out.println(RED + "Invalid choice!" + RESET);
                            pause();
